...
@section('content')
    <div id="prd-catalogue" class="page-body">
        ...
        @php
            $isSanPhamPage = ($productCatalogue->canonical == 'san-pham');
        @endphp
                    ...
                    <div class="prd-catalogue">
                        @if (isset($subCategories) && count($subCategories))
                            <div class="subcategory-grid-wrapper">
                                <ul class="uk-list uk-clearfix uk-grid uk-grid-medium uk-grid-width-1-1 uk-grid-width-small-1-2 uk-grid-width-medium-1-2 uk-grid-width-large-1-2" data-uk-grid-margin>
                        ...
                        @else
                            <div class="no-products uk-text-center uk-margin-large-top uk-margin-large-bottom">
                                <p>Không tìm thấy danh mục con nào.</p>
                            </div>
                        @endif
                    </div>
                @else
