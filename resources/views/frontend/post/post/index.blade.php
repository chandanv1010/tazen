        ...
        <div class="cat-hero-section" style="background-image: url('/vendor/frontend/img/project/breadcrumb.png');">
            ...
            <div class="uk-container uk-container-center cat-hero-container">
                ...
                <ul class="uk-list uk-clearfix uk-flex uk-flex-middle uk-flex-center cat-hero-breadcrumbs">
                    ...
                    @endif
                    <li class="separator">&raquo;</li>
                    <li><a href="#" onclick="return false;">{{ $post->name }}</a></li>
                </ul>
            </div>
        </div>
                ...
                <div class="uk-grid uk-grid-large">
                    ...
                    <div class="uk-width-large-3-4">
                        <div class="art-detail">
                            <h1 style="font-family: 'Montserrat', sans-serif; font-size: 32px; font-weight: 850; color: #222; margin-bottom: 20px; line-height: 1.3;">
                                {{ $post->name }}
                            </h1>
                            ...
                            @if($postCatalogue->canonical === 'du-an-tieu-bieu')
                                <div class="project-info-card project-info-card-in-content uk-margin-bottom" style="background: #fdfdfd; border: 1px solid #eee; padding: 25px; border-radius: 8px; box-shadow: 0 10px 30px rgba(0,0,0,0.02);">
                                    <h3 class="info-card-title" style="font-family: 'Montserrat', sans-serif; font-size: 18px; font-weight: 700; color: #1e4794; text-transform: uppercase; border-bottom: 2px solid #f37a20; padding-bottom: 12px; margin-bottom: 20px; text-align: left;">
                                        Thông tin dự án
                                    </h3>
                            ...
                            @else
                                <div class="description uk-text-lead" style="font-size: 16px; line-height: 1.8; color: #555; font-weight: 600; margin-bottom: 30px;">
                                    {!! $post->description !!}
                                </div>
                            @endif

                            <div class="content-body" style="font-size: 15px; line-height: 1.8; color: #444; margin-bottom: 40px;">
                                {!! $post->content !!}
                            </div>
